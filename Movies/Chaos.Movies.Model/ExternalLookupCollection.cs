...
namespace Chaos.Movies.Model
{
    ...
    public class ExternalLookupCollection : Listable<ExternalLookup, ExternalLookupDto, ExternalLookupCollection, ReadOnlyCollection<ExternalLookupDto>>
    {
        ...
        /// <inheritdoc />
        public override ReadOnlyCollection<ExternalLookupDto> ToContract(string languageName)
        {
            return new ReadOnlyCollection<ExternalLookupDto>(this.Items.Select(item => item.ToContract(languageName)).ToList());
        }
        ...
        public override ExternalLookupCollection FromContract(ReadOnlyCollection<ExternalLookupDto> contract)
        {
            if (contract == null)
            {
                return new ExternalLookupCollection();
            }
