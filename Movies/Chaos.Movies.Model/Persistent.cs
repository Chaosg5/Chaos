...
namespace Chaos.Movies.Model
{
    ...
    public static class Persistent
    {
        ...
        public static readonly string ConnectionString = "Data Source=192.168.1.123;Initial Catalog=CMDB;User Id=WebUser;Password=MSdNhYK3haQ9SKcw;"; //ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString;
